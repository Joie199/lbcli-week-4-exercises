...
rawtxhex=$(bitcoin-cli -regtest createrawtransaction '[{"txid":"'"$txid"'","vout":0,"sequence":4294967294},{"txid":"'"$txid"'","vout":1,"sequence":4294967294}]' '{"'"$address"'":0.20000000,"'"$change_address"'":0.03678108}' 2041)
echo "$rawtxhex"